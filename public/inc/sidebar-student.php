<aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link <?php if($page != 'organization_single.php' && $page != 'organization.php') { echo 'collapsed'; } ?>" href="./../../organization">
      ...
      <li class="nav-item">
        <a class="nav-link <?php if($page != 'newsfeed.php' && $page != 'newsfeed_community.php' && $page != 'newsfeed_single.php') { echo 'collapsed'; } ?>" href="./../../newsfeed">
          ...
          <span>Newsfeed <span class="badge bg-danger text-white">99+</span></span>
        </a>
      </li>

      <li class="nav-item">
        <a class="nav-link <?php if($page != 'learn.php') { echo 'collapsed'; } ?>" href="./../../learn">
          <i class="bi bi-book-half"></i>
          <span>Learn Hub <span class="badge bg-danger text-white">4</span></span>
        </a>
      </li>
